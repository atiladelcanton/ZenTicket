            ...
            <div class="col-md-6 col-sm-12">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item "><a href="{{route('tipos-de-chamados')}}">Impactos</a></li>
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12">
            <div class="card planned_task">
                <div class="body">
                    <form action="{{ route('tipos-de-chamados.registrar') }}" method="post">
                        {{ @csrf_field() }}
                            <div class="row">
                                <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <button type='button' class="btn btn-outline-warning"
                                    onclick="location.href =  '{{route('tipos-de-chamados')}}' ">Voltar
                            </button>
