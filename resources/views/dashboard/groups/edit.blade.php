    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12">
            <div class="card planned_task">
                <div class="body">
                    <form action="{{ route('grupos.alterar', ['id' => $role->id]) }}" method="post">
                        {{ @csrf_field() }}
                        <fieldset>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" id="name" name="name"
                                               placeholder="Digite o nome" value="{{$role->name}}">
                                    </div>
                                </div>
                            </div>
                        </fieldset>
                                ...
                                @foreach($modules as $module)
                                    <tr>
                                        ...
                                        @foreach($module->permissions as $permission)
                                            ...
                                            <td class="text-center">
                                                <div class="fancy-checkbox">
                                                    <label><input class="form-control" type="checkbox" {{ in_array($permission->id, $permissions) ? 'checked' : '' }} name="permissions[{{ $permission->id }}]"><span>&nbsp;</span></span></label>
                                                </div>
